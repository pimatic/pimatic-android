...
public class AccountTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_acctounts);
        ...
        findViewById(R.id.btnGetAuthToken).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAccountPicker(AccountGeneral.AUTHTOKEN_TYPE_CONNECTION_URL, false);
            }
        });
        ...
        findViewById(R.id.btnGetAuthTokenConvenient).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getTokenForAccountCreateIfNeeded(AccountGeneral.ACCOUNT_TYPE, AccountGeneral.AUTHTOKEN_TYPE_CONNECTION_URL);
            }
        });
        findViewById(R.id.btnInvalidateAuthToken).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAccountPicker(AccountGeneral.AUTHTOKEN_TYPE_CONNECTION_URL, true);
            }
        });
...
//            if (showDialog) {
//                showAccountPicker(AccountGeneral.AUTHTOKEN_TYPE, invalidate);
//            }
//        }
